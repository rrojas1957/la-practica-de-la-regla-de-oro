...
export const translations: Record<"es" | "en" | "fr" | "de" | "pt" | "ru", TranslationDict> = {
  es: {
  ...
  de: {
    ...
    downloadFooterQuote: "Wenn du andere so behandelst, wie du selbst behandelt werden möchtest, befreist du dich. — Silo"
  },
  pt: {
  ...
  ru: {
    logoTitle: "Золотое правило",
    logoSubtitle: "Интерактивная практика",
    tabIntro: "Введение",
    tabPractice: "Практика",
    tabHistory: "История",
    tabSupport: "Библиотека и ссылки",
    themeToggleDark: "Переключиться на тёмную тему",
    themeToggleLight: "Переключиться на светлую тему",
    toastThemeChanged: "Тема изменена на:",
    toastFormReset: "Форма успешно сброшена.",
    toastPracticeSaved: "Практика успешно сохранена в вашей истории!",
    toastPracticeLoaded: "Практика загружена:",
    toastPracticeDeleted: "Практика удалена из истории.",
    toastExampleLoaded: "Загружен полный решённый пример. Проверьте карту и ключевые идеи.",
    toastPracticeReady: "Пример успешно загружен в ваше рабочее пространство. Сравните его на карте!",
    toastFormCheck: "Пожалуйста, ответьте хотя бы на первые вопросы перед сохранением.",
    toastDownloadSuccess: "Текстовый файл успешно загружен.",
    introTagline: "Личная трансформация и ненасилие",
    introTitle: "Практика золотого правила",
    introSubtitle: "Практический путь к преодолению механических реакций, пониманию своих внутренних состояний и осознанному выбору доброго обращения.",
    introPrivacyTitle: "🔒 100% безопасное и личное пространство",
    introPrivacyText: "Это упражнение является инструментом самопознания и носит строго личный характер. Для вашего полного спокойствия ответы, которые вы вводите на протяжении этих пунктов, не хранятся ни на каком внешнем сервере и не записываются ни в одну базу данных, доступную третьим лицам. Всё, что вы пишете, обрабатывается временно и локально на вашем экране для вашей собственной внутренней работы. Практикуйте с абсолютной свободой.",
    introPrincipleTitle: "Центральный принцип",
    introSiloQuote: "Когда ты обращаешься с другими так, как хочешь, чтобы обращались с тобой, ты освобождаешь себя.",
    introInspiration: "Эта практика вдохновлена Золотым правилом Нового гуманизма, представленным в книге «Золотое правило ненасилия» Роберто Коганофф и Исабель Лаззарони.",
    introSiloAuthor: "— Сило, Универсалистский гуманизм",
    introBenefitsTitle: "Практика Золотого правила помогает нам:",
    introBenefits: [
      "Останавливать компульсивные реакции и выбирать, как мы хотим действовать (отложенная реакция).",
      "Понимать, почему определённые отношения или поведение других так сильно на нас влияют.",
      "Освобождаться от внутреннего напряжения, противоречий и негативных настроений (климатов).",
      "Улучшать наши отношения, потому что мы перестаём требовать, чтобы другой изменился, и начинаем меняться сами.",
      "Строить более последовательный, добрый и свободный образ жизни.",
      "Речь идёт не о том, чтобы быть совершенным или «хорошо себя вести». Речь идёт о том, чтобы научиться жить с большей осознанностью и меньшим внутренним насилием, шаг за шагом."
    ],
    introPurposeTitle: "Эта практика полезна для того, чтобы:",
    introPurposes: [
      "Лучше понять себя и признать, что причиняет нам боль и почему.",
      "Обнаружить повторяющиеся паттерны, уходящие корнями в нашу личную историю.",
      "Разорвать цепь внутреннего и внешнего насилия.",
      "Действовать из наших лучших добродетелей, а не из импульса момента.",
      "Повышать уровень осознанности, что улучшает нашу жизнь и жизнь окружающих.",
      "Со временем эта практика становится инструментом для жизни с большим внутренним единством: думать, чувствовать и действовать в одном направлении.",
      "Это приложение будет направлять вас шаг за шагом, чтобы вы могли практиковать его простым, глубоким и доступным образом. Независимо от вашего возраста, культуры, истории или нынешней ситуации: мы все можем научиться жить с меньшим насилием и большей внутренней свободой."
    ],
    introExplanation: "Все мы переживаем моменты напряжения, гнева, разочарования или замешательства. Иногда мы реагируем чисто механически или компульсивно с низкого уровня сознания. Эта практика — инструмент самопознания и личной трансформации, призванный помочь вам остановить автоматическую реакцию, понять свои внутренние состояния и осознанно выбрать доброе обращение. Это не жёсткая норма или моральное обязательство, а путь к жизни с меньшим страданием, большим внутренним единством и подлинной свободой.",
    introPurposesExtra: "Это приложение будет направлять вас шаг за шагом, чтобы вы могли практиковать его простым, глубоким и доступным образом. Независимо от вашего возраста, культуры, истории или нынешней ситуации: мы все можем научиться жить с меньшим насилием и большей внутренней свободой.",
    introBtnStart: "Начать новую практику",
    introBtnExample: "Просмотреть решённый пример",
    practiceTitleLabel: "Практика в процессе",
    practiceTitlePlaceholder: "Дайте название своему размышлению (напр., Преодоление рабочего конфликта)",
    practiceProgressLabel: "Общий прогресс:",
    practiceCompletedCount: "выполнено",
    practicePrivacyTitle: "Гарантия полной конфиденциальности и приватности",
    practicePrivacyText: "Ваша практика рефлексии абсолютно приватна. Всё, что вы пишете, хранится локально и безопасно в базе данных вашего браузера (localStorage). Никакие личные данные, размышления или ответы не отправляются на внешние серверы или облачные базы данных. Ваша эмоциональная интимность полностью защищена.",
    practiceQuestionLabel: "Вопрос",
    practiceTypeLuminous: "Светлое пространство",
    practiceTypeDark: "Возмущённое пространство",
    practiceTypeTransition: "Переход",
    practiceInputWordLabel: "Ваше слово или короткая фраза:",
    practiceBtnPrev: "Назад",
    practiceBtnNext: "Далее",
    practiceBtnLastPrompt: "Последний вопрос!",
    practiceHelpPrompt: "Если вы не можете найти подходящее слово, вы можете поискать помощь в этой панели.",
    ...
    previewGoldenTitle: "Формула преодоления (Необязательный I):",
    previewGoldenTemplate: "Чтобы избежать {p2} перед лицом {p1}, я предлагаю обращение {p3}, делая {p4}.",
    previewHint: "✨ Наблюдайте, как ваши размышления динамически интегрируются в реальном времени в эти логические предложения.",
    actionTitle: "Хотите сохранить свою сессию?",
    actionSubtitle: "Сохраните ваши ответы в личную историю, чтобы просмотреть их позже.",
    actionBtnReset: "Сбросить",
    actionBtnSave: "Сохранить практику",
    actionResetConfirm: "Вы уверены, что хотите сбросить текущие ответы? Ваш активный черновик будет потерян.",
    resultsCompletedTitle: "Вы завершили все 8 пунктов практики!",
    resultsCompletedSubtitle: "Ваш ум перешёл от реактивности к самосознанию. Ниже вы можете созерцать свои финальные афоризмы.",
    resultsBtnSaveHistory: "Сохранить в истории",
    resultsSynthesisTitle: "Ваш синтез на подходе",
    resultsSynthesisSubtitle: "Ответьте на {totalSteps} вопросов анкеты, чтобы сгенерировать набор интерактивных афоризмов для саморазвития. В настоящее время у вас {answeredCount} из {totalSteps}.",
    aforismosTitle: "Ваши ключевые идеи и сгенерированные афоризмы",
    aforismosSubtitle: "Формулы и логические утверждения, одновременно построенные из вашего размышления.",
    aforismosBtnDownload: "Скачать всё",
    aforismosCopiedTitle: "Копировать афоризм",
    aforismosCopiedMessage: "Афоризм скопирован в буфер обмена",
    historyTitle: "Ваша история сохранённых практик",
    historySubtitle: "Здесь хранятся ваши предыдущие работы по самопознанию. Они сохранены локально на вашем устройстве.",
    historyEmptyTitle: "История сохранённых практик пуста",
    historyEmptyText: "У вас ещё нет сохранённых размышлений в браузере. Заполните анкету на вкладке «Практика» и нажмите «Сохранить практику», чтобы начать вести личный дневник.",
    historyBtnStartNew: "Начать первую практику",
    historyCardDate: "Дата записи:",
    historyBtnLoad: "Загрузить в рабочее пространство",
    historyBtnDelete: "Удалить",
    historyDeleteConfirm: "Вы уверены, что хотите удалить эту практику из истории? Это действие нельзя отменить.",
    supportTitle: "Библиотека и вспомогательные материалы",
    supportSubtitle: "Углубите своё понимание Золотого правила с помощью оригинальных литературных ссылок и глоссария терминов Нового гуманизма.",
    supportTabExamples: "Примеры и отзывы",
    supportTabGlossary: "Глоссарий терминов",
    supportTabResources: "Библиотека ссылок",
    supportTabMailbox: "Почтовый ящик и контакт",
    supportExamplesTitle: "Тематические исследования и вдохновляющие практики",
    supportExamplesSubtitle: "Просмотрите эти реальные и анонимные решённые упражнения, чтобы направить вас в вашем собственном внутреннем размышлении.",
    supportExamplesBtnLoad: "Загрузить этот пример в рабочее пространство",
    supportExamplesAforismoLabel: "Результирующий ключевой афоризм:",
    supportExamplesCommentaryLabel: "Комментарий к упражнению:",
    supportGlossarySearchPlaceholder: "Поиск термина или определения...",
    supportGlossaryEmpty: "Термины, соответствующие вашему поиску, не найдены.",
    supportResourcesTitle: "Книги и лекции для ознакомления",
    supportResourcesSubtitle: "Получите прямой доступ к основополагающей литературе гуманистической мысли и методологии активного ненасилия.",
    supportResourcesAuthor: "Автор:",
    supportResourcesPublisher: "Издатель:",
    supportResourcesYear: "Год:",
    supportResourcesTypeBook: "Книга",
    supportResourcesTypeConference: "Конференция",
    supportResourcesTypeSpeech: "Обращение Сило",
    supportResourcesTypeManual: "Руководство",
    supportResourcesTypeVideo: "YouTube-канал",
    supportResourcesTypePdf: "Книга в формате PDF",
    supportMailboxTitle: "Почтовый ящик и обратная связь",
    supportMailboxSubtitle: "Отправляйте свои мнения, сомнения или технические отчёты непосредственно команде разработчиков полностью анонимно.",
    supportMailboxPrivateCheckTitle: "Гарантия полной анонимности",
    supportMailboxPrivateCheckText: "Ваша конфиденциальность защищена. Этот почтовый ящик не собирает ваш email, IP, геолокацию или любые данные, которые могли бы вас идентифицировать. Сообщения шифруются и передаются прямо на таблицу управления для технической и содержательной проверки.",
    supportMailboxLabelCategory: "Категория сообщения:",
    supportMailboxCategoryOpinion: "Мнение или предложение",
    supportMailboxCategoryError: "Сообщить о техническом баге",
    supportMailboxCategoryQuestion: "Концептуальное/методологическое сомнение",
    supportMailboxCategoryOther: "Другая тема",
    supportMailboxLabelMessage: "Содержание вашего сообщения:",
    supportMailboxPlaceholderMessage: "Пишите здесь ваши идеи, предложения или комментарии с полной свободой...",
    supportMailboxBtnSend: "Отправить анонимное сообщение",
    supportMailboxBtnSending: "Безопасная отправка...",
    supportMailboxSuccessTitle: "Сообщение успешно отправлено!",
    supportMailboxSuccessText: "Большое спасибо за ваш вклад. Ваше сообщение было безопасно интегрировано в нашу таблицу управления и будет проанализировано с глубоким уважением технической командой.",
    supportMailboxBtnSendAnother: "Отправить ещё одно сообщение",
    downloadHeader: "ПРАКТИКА ЗОЛОТОГО ПРАВИЛА",
    downloadPracticeTitle: "Название размышления:",
    downloadDate: "Дата скачивания:",
    downloadResponsesHeader: "ОТВЕТЫ НА АНКЕТУ:",
    downloadAforismosHeader: "КЛЮЧЕВЫЕ ИДЕИ И СГЕНЕРИРОВАННЫЕ АФОРИЗМЫ:",
    downloadNotesHeader: "ЛИЧНЫЕ ЗАМЕТКИ / РАБОЧИЙ ДНЕВНИК:",
    downloadNotesEmpty: "Нет дополнительных заметок.",
    downloadFooterQuote: "Когда ты обращаешься с другими так, как хочешь, чтобы обращались с тобой, ты освобождаешь себя. — Сило"
  }
};
...
export const STEPS_RU: StepConfig[] = [
  {
    id: 1,
    label: "Пункт 1: Плохое обращение, которое я отвергаю",
    shortName: "Плохое обращение, которое я отвергаю",
    question: "Какое плохое обращение я отвергаю?",
    description: "Определите ту позицию, действие или поведение других людей, которое вы считаете насильственным, болезненным или неприемлемым. Это внешняя ситуация, нарушающая ваше благополучие.",
    helpDescription: "Выберите тип плохого обращения, который наиболее вам резонирует, или напишите своё слово:",
    placeholder: "напр., Исключение, Безразличие, Пренебрежение...",
    type: "dark",
    categories: [
      {
        categoryName: "Исключение и безразличие",
        words: ["Исключение", "Безразличие", "Игнорирование", "Отвержение", "Изоляция", "Презрение", "Пренебрежение", "Маргинализация", "Невидимость"]
      },
      {
        categoryName: "Агрессия и унижение",
        words: ["Агрессия", "Оскорбления", "Крики", "Унижение", "Насмешки", "Пренебрежение", "Критика", "Осуждение", "Умаление", "Высокомерие"]
      },
      {
        categoryName: "Контроль и господство",
        words: ["Порабощение", "Манипуляция", "Требовательность", "Несправедливость", "Контроль", "Злоупотребление властью", "Навязывание", "Авторитаризм", "Ложь", "Предательство"]
      }
    ]
  },
  {
    id: 2,
    label: "Пункт 2: Моя реакция и состояние",
    shortName: "Моя реакция / состояние",
    question: "Как я себя чувствую и что делаю в ответ на это плохое обращение?",
    description: "Распознайте свою механическую реакцию на Пункт 1. Она отражает ваше возмущённое состояние — защитную, гневную или страдающую реакцию, которая возникает автоматически.",
    helpDescription: "Выберите, как вы обычно реагируете или чувствуете себя в ответ на это возмущение:",
    placeholder: "напр., Я страдаю и отдаляюсь, Я кричу от ярости, Я виню себя...",
    type: "dark",
    categories: [
      {
        categoryName: "Отстранение и страдание",
        words: ["Я страдаю и отстраняюсь", "Я изолируюсь", "Я впадаю в депрессию", "Я замыкаюсь с обидой", "Я чувствую себя виноватым/виноватой", "Я смиряюсь", "Я чувствую себя беспомощным/беспомощной"]
      },
      {
        categoryName: "Гнев и контратака",
        words: ["Я кричу от ярости", "Я атакую в ответ", "Я ищу мести", "Я раздражаюсь", "Я жалуюсь с насилием", "Я спорю не слушая", "Я отвечаю тем же"]
      },
      {
        categoryName: "Тревога и паралич",
        words: ["Я боюсь и убегаю", "Я цепенею", "Я тревожусь", "Я напрягаюсь физически", "Я чувствую себя брошенным/брошенной", "Я ищу покорного одобрения"]
      }
    ]
  },
  {
    id: 3,
    label: "Пункт 3: Обращение, которое я прошу и даю",
    shortName: "Обращение, которое я прошу / даю",
    question: "Какого обращения я прошу от тех, кто плохо обращался со мной, чтобы самому/самой его давать?",
    description: "Противоположная добродетель к Пункту 1. Это доброе обращение, которое вы хотели бы получить и которое обязуетесь давать первым, поднимая уровень сознания.",
    helpDescription: "Выберите вдохновляющее доброе обращение, противоположное плохому обращению в Пункте 1:",
    placeholder: "напр., Внимание и включённость, Искренняя признательность, Активное слушание...",
    type: "luminous",
    categories: [
      {
        categoryName: "Включённость и приветствие",
        words: ["Внимание и включённость", "Принятие", "Искреннее приветствие", "Внимательное слушание", "Признание", "Интеграция", "Близость"]
      },
      {
        categoryName: "Привязанность и ценность",
        words: ["Искренняя признательность", "Глубокое уважение", "Доброта", "Терпимость", "Взаимная забота", "Сострадание", "Эмпатия", "Признание ценности"]
      },
      {
        categoryName: "Свобода и мир",
        words: ["Свобода", "Абсолютное доверие", "Безусловная поддержка", "Справедливость", "Понимание", "Искренность", "Внутренний мир"]
      }
    ]
  },
  {
    id: 4,
    label: "Пункт 4: Альтернативное доброе обращение",
    shortName: "Альтернативное доброе обращение",
    question: "Как я это делаю? (Доброе обращение, противоположное моей реакции в Пункте 2)",
    description: "Противоположная добродетель к Пункту 2. Это осознанное и конструктивное действие, которое вы совершаете вместо привычной реактивной реакции.",
    helpDescription: "Выберите добродетельное действие, нейтрализующее негативную реакцию Пункта 2:",
    placeholder: "напр., Я приближаюсь и ценю других, Я спокойно веду диалог...",
    type: "luminous",
    categories: [
      {
        categoryName: "Сближение и ценность",
        words: ["Я приближаюсь и ценю других", "Я веду диалог честно", "Я выражаю свою привязанность", "Я сопровождаю с терпением", "Я ценю добродетели других"]
      },
      {
        categoryName: "Спокойствие и безмятежность",
        words: ["Я дышу спокойно", "Я слушаю с открытостью", "Я действую без спешки", "Я стараюсь понять прежде чем судить", "Я искренне прощаю", "Я примиряюсь"]
      },
      {
        categoryName: "Твёрдость и самозабота",
        words: ["Я устанавливаю здоровые границы с любовью", "Я выражаю себя твёрдо и спокойно", "Я ценю себя", "Я доверяю своей внутренней силе", "Я открываюсь без страха"]
      }
    ]
  },
  {
    id: 5,
    label: "Пункт 5: Мой путь падения (с 3 на 2)",
    shortName: "Путь падения 3 → 2",
    question: "Как я падаю от добродетельного обращения (3) к механической реакции (2)?",
    description: "Определите, какая позиция, убеждение, страх, ожидание или уязвимость саботирует ваши добрые намерения и заставляет вас соскальзывать обратно в страдание или гнев.",
    helpDescription: "Выберите внутренний фактор, который заставляет вас опускаться к реактивности Пункта 2:",
    placeholder: "напр., Неуверенность, Несбывшиеся ожидания, Гордость...",
    type: "transition",
    direction: "down",
    fromId: 3,
    toId: 2,
    categories: [
      {
        categoryName: "Неуверенность и сомнение",
        words: ["Неуверенность", "Недоверие", "Сомнения в себе", "Ревность", "Раненая уязвимость", "Страх отвержения"]
      },
      {
        categoryName: "Ожидания и гордость",
        words: ["Чрезмерные ожидания", "Раненая гордость", "Высокомерие", "Тщеславие", "Эгоизм", "Перфекционистские требования"]
      },
      {
        categoryName: "Слабость и страх",
        words: ["Страх неудачи", "Страх боли", "Социальная трусость", "Пассивный комфорт", "Внутренняя лень", "Апатия"]
      }
    ]
  },
  {
    id: 6,
    label: "Пункт 6: Мой путь подъёма (с 2 на 3)",
    shortName: "Путь подъёма 2 → 3",
    question: "Как я поднимаюсь от возмущённого состояния (2) к добродетельному обращению (3)?",
    description: "Распознайте намеренное действие, которое позволяет вам повысить уровень сознания, разорвать петлю страдания или гнева и вновь соединиться с добродетелью.",
    helpDescription: "Выберите мост, который помогает вам вернуться к светлому состоянию Пункта 3:",
    placeholder: "напр., Я выражаю то, что чувствую и думаю, Я осознаю, Я дышу...",
    type: "transition",
    direction: "up",
    fromId: 2,
    toId: 3,
    categories: [
      {
        categoryName: "Честная коммуникация",
        words: ["Я выражаю то, что чувствую и думаю", "Я прошу помощи со смирением", "Я честно говорю, что происходит", "Я веду диалог с откровенностью", "Я говорю от сердца"]
      },
      {
        categoryName: "Осознанность и рефлексия",
        words: ["Я размышляю в тишине", "Я осознаю механичность", "Я глубоко дышу и наблюдаю", "Я принимаю свою часть", "Я медитирую в спокойствии"]
      },
      {
        categoryName: "Смелое действие",
        words: ["Я беру инициативу на исправление", "Я рискую измениться", "Я действую с мужеством", "Я беру ответственность за себя", "Я решаю не причинять вреда"]
      }
    ]
  },
  {
    id: 7,
    label: "Пункт 7: Мой путь падения (с 4 на 1)",
    shortName: "Путь падения 4 → 1",
    question: "Как я падаю от альтернативного доброго обращения (4) к реактивному плохому обращению (1)?",
    description: "Определите, что изматывает или расстраивает вас при попытке сохранить доброе обращение, заставляя терять терпение и возвращаться к жестокой или отвергающей позиции.",
    helpDescription: "Выберите то, что снижает вашу мотивацию и заставляет возвращаться к вредному поведению:",
    placeholder: "напр., Выгорание, Крайняя усталость, Разочарование...",
    type: "transition",
    direction: "down",
    fromId: 4,
    toId: 1,
    categories: [
      {
        categoryName: "Усталость и насыщение",
        words: ["Выгорание", "Накопленная усталость", "Умственное насыщение", "Перегруженность рутиной", "Стресс", "Истощение энергии"]
      },
      {
        categoryName: "Разочарование и уныние",
        words: ["Разочарование в другом", "Разочарование от отсутствия изменений", "Пессимизм", "Безразличие", "Обида", "Ощущение, что это не стоит того"]
      },
      {
        categoryName: "Нетерпение и раздражительность",
        words: ["Нетерпение", "Сдержанная ярость", "Нулевая терпимость", "Накопленное раздражение", "Постоянная раздражительность", "Желание наказать"]
      }
    ]
  },
  {
    id: 8,
    label: "Пункт 8: Мой путь подъёма (с 1 на 4)",
    shortName: "Путь подъёма 1 → 4",
    question: "Как я поднимаюсь от отвергающей позиции/плохого обращения (1) к альтернативному доброму обращению (4)?",
    description: "Откройте для себя глубокое намерение или действие, которое позволяет вам преодолеть отвержение, примириться и взять на себя обязательство совершить конструктивное действие Пункта 4.",
    helpDescription: "Выберите глубокий мост, который вновь соединяет вас с благожелательным обращением Пункта 4:",
    placeholder: "напр., Я соединяюсь с Человеческим в себе и других, Я прощаю, Я чувствую эмпатию...",
    type: "transition",
    direction: "up",
    fromId: 1,
    toId: 4,
    categories: [
      {
        categoryName: "Человеческая связь",
        words: ["Я соединяюсь с Человеческим в себе и других", "Я смотрю на другого как на равного", "Я чувствую эмпатию к его/её боли", "Я ищу то, что нас объединяет, а не то, что разделяет"]
      },
      {
        categoryName: "Примирение и сострадание",
        words: ["Я прощаю и отпускаю обиду", "Я примиряюсь глубоко", "Я чувствую сострадание к его/её невежеству", "Я принимаю, что мы все совершаем ошибки"]
      },
      {
        categoryName: "Любовь в действии",
        words: ["Я действую с благожелательностью", "Я желаю благополучия другим от всего сердца", "Я ищу единство и мир", "Я берусь за ненасилие"]
      }
    ]
  }
];
...
export function generateAforismosTranslated(answers: Record<number, string>, lang: 'es' | 'en' | 'fr' | 'de' | 'pt' | 'ru'): AforismoOutput[] {
  ...
  if (lang === 'es') {
    ...
    const p1 = p1Raw !== "" ? p1Raw : "[Плохое обращение 1]";
    const p2 = p2Raw !== "" ? p2Raw : "[Реакция 2]";
    const p3 = p3Raw !== "" ? p3Raw : "[Добродетель 3]";
    const p4 = p4Raw !== "" ? p4Raw : "[Действие 4]";
    const p5 = p5Raw !== "" ? p5Raw : "[Падение 5]";
    const p6 = p6Raw !== "" ? p6Raw : "[Подъём 6]";
    const p7 = p7Raw !== "" ? p7Raw : "[Падение 7]";
    const p8 = p8Raw !== "" ? p8Raw : "[Подъём 8]";

    // Устойчивый простой шаблон (по образцу немецкого варианта Ангелики): каждый ответ — отдельное предложение от первого лица.
    // Ответы-существительные (1, 3, 5, 7) обрамляются глаголом; предложения от первого лица (2, 4, 6, 8) остаются без изменений.
    const ruSatz = (s: string): string => {
      const t = s.trim();
      if (t === "") return "";
      const withDot = /[.!?]$/.test(t) ? t : t + ".";
      return withDot.charAt(0).toUpperCase() + withDot.slice(1);
    };
    const aforismoPrincipalText = [ruSatz(p6), ruSatz(`Я развиваю ${p3}`), ruSatz(p8), ruSatz(p4)].join(" ");
    const opcionalIText = [ruSatz(p2), ruSatz(`Я осознаю ${p1}`), ruSatz(`Я выбираю ${p3}`), ruSatz(p4)].join(" ");
    const opcionalIIText = [ruSatz(p2), ruSatz(`Я осознаю ${p5}`), ruSatz(p6), ruSatz(`Я развиваю ${p3}`)].join(" ");
    const opcionalIIIText = [ruSatz(`Я чувствую ${p7}`), ruSatz(`Я осознаю ${p1}`), ruSatz(p8), ruSatz(p4)].join(" ");

    return [
      {
        id: "6+8",
        title: "Афоризм подъёма (Интеграция путей)",
        formula: "Через [Пункт 6] я поднимаюсь к [Пункт 3] и через [Пункт 8] я поднимаюсь к [Пункт 4]",
        text: aforismoPrincipalText
      },
      {
        id: "opcional-1",
        title: "Афоризм преодоления кризиса (Опционально I)",
        formula: "Чтобы избежать [Пункт 2] перед лицом [Пункт 1], я отвечаю [Пункт 3], делая [Пункт 4]",
        text: opcionalIText
      },
      {
        id: "opcional-2",
        title: "Разрешение эмоционального конфликта (Опционально II)",
        formula: "Через [Пункт 5] я падаю в [Пункт 2], но через [Пункт 6] я поднимаюсь к [Пункт 3]",
        text: opcionalIIText
      },
      {
        id: "opcional-3",
        title: "Преодоление активного отвержения (Опционально III)",
        formula: "Через [Пункт 7] я падаю перед [Пункт 1], но через [Пункт 8] я поднимаюсь к [Пункт 4]",
        text: opcionalIIIText
      }
    ];
  } else {
